...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Splot filtru Gaussa z obrazem daje w wyniku wygładzony obraz ze zmniejszoną ilością szu
    mu.
    ...
    W wyniku powyższego działania zostaje otrzymany obraz gradientowy.
    ...
    pikseli, które znajdują się wzdłuż dwóch linii.
    Jedna z nich jest wyznaczona przed aktualny kierunek gradientu, a druga przez przeciwny kierunek.
    ...
    \subsection{Likwidacja krawędzi o małym gradiencie jasności}\label{subsec:likwidacja-krawędzi-o-małym-gradiencie-jasności}
