...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    zsumowany deskryptor HOG-a. Dla strefy 1 deskryptor jest opisany %todo sprawdzic czy ma sens
    ...
    \section{Środowisko i metodyka badań}\label{sec:środowisko-pracy}
    ...
    %todo opisac zbior danych, dokladne statystyki ile zdjec takich taki srednia itp...
    ...
    %todo opisac, ze dokonano badan w oparciu o rozdzial 90 - 10 oraz CV-5
    ...
    Pierwszym przykładem było wykrycie krawędzi związanych z brwiami (obraz~\ref{fig.zlyRyjek}) dla osób z przedziału
    wieku...

    %todo opis, że podzielono na dwie grupy po 30 probek i sprawdzono problem
    ...
    %    Najlepiej byłoby jakby te zakresy nie naszły na siebie. Dobrze byłoby mieć po 30 próbek na grupę
    ...
    Kolejnym problemem okazała się grzywka nachodząca na obszar strefy 1. %todo tak samo tutaj zdefiniowac problem
    ...
    %todo opisac jak w matlabie wygladalo szacowanie, ewentualnie jak w pythonie :)
    ...
    \end{table}
    \subsection*{Wyniki z testowania 100 zdjęć}
    ...
    \subsection*{Wyniki walidacji krzyżowej CV-5} %todo
