...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Klasteryzacja Fuzzy C-means dzieli zbiór $F$ na podzbiory $f_{i}$ zgodnie ze wzorem~\ref{wzor.zbiorX}):
    \large
    \begin{equation}
        F:=\{f_{1},f_{2},f_{3},\ldots,f_{n}\}\subset \mathbb{R} %todo zamienic na f wszystkie xi
        \label{wzor.zbiorX}
    \end{equation}
    \normalsize
    ...
    %    todo pozbyc sie przecinkow wyszacych za wzorami
    \large
    \begin{equation}
