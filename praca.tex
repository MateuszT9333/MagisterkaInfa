...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    można uzyskać szerokie spektrum barw \ref{fig.mieszanieKolorow}.
    ...
    Przykładowo kolor o reprezentacji R=153 G=217 B=234 przedstawiono na \ref{fig.mieszanieKolorowBlekitny}
    ...
    Kolor \ref{fig.mieszanieKolorowBlekitny} może być też reprezentowany w kodzie szesnastkowym \#99D9EA. Każda
