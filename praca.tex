...
%    " jako ostre jak przedstawiono na rys. 2.3." Proszę zobaczyć czy w innych miejscach też nie da się w prosty sposób wprowadzić odwołania do rynku jako części zdania.
    ...
    można
    oszacować wiek~\cite{wrinkleFeatures}. %todo sprawdzic referencje na sam koniec ctrl + f i "?" w Adobe reader
    ...
    Algorytm Fuzzy C-means został stworzony w 1973 przez J. C. Dunn. Po raz pierwszy został opisany w~książce~\cite{ISODATA}.
