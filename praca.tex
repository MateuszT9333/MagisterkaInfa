...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    W celu poprawy efektywności sumowania pikseli w filtrze Haara stosowane są %todo bzdura - to nie jest stosowane w
    %todo w filtrze Haara
    ...
    pomocą filtru Haara wynosi zwykle powyżej stu tysięcy \cite{violaJones}. %todo w Violi to jest dobrze opisane
    Wiele z nich nie ma
    ...
    Taką właśnie techniką jest AdaBoost. %todo dopisac o adaboost
    ...
    wytworzenia silnych klasyfikatorów. %todo opisac kaskade
