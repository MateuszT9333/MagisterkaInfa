...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Natomiast miękka klasteryzacja oznacza, że każdy element danych może w pewnym stopniu należeć do każdej z grup.
    ...
    centroidem $p_{j}$. Parametr ,,m'' jest nazywany współczynnikiem rozmycia. Współczynnik ,,m'' może być w zakresie
    od 1 do nieskończoności. W większości przypadków współczynnik jest równy 2.
