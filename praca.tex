...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    W tym miejscu kończy się faza wyznaczania wrinkle feature dla danej osoby \ref{fig.faza1Algorytmu}. Kolejna faza jest potrzebna do
    ...
    wartość heksydecymalna odpowiada kolejno kanałowi R, G, B.
