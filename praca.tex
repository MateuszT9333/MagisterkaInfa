...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    \section{Wnioski}
    Przetestowano metodę bazową oraz jej modyfikację pod kątem jakości szacowania wieku.

    Testowanie metody bazowej oraz jej modyfikacji wykazało, że wskaźnik MAE oscylował w granicach 10 lat. Nie jest
    to wartość zadawalająca, gdyż w literaturze powyższy wskaźnik osiągał wartości około 5 lat.
