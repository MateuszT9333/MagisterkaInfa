...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    a następnie poddano ją kilku modyfikacjom.

    Zakres pracy obejmuje następujące zagadnienia:
    \begin{itemize}
        \item Implementacja algorytmu z pracy~\cite{wrinkleFeatures}, w dalszej części pracy nazywany oryginalną metodą.
    ...
    W przedostatniej sekcji~\ref{sec:algorytmTrenowania} niniejszego rozdziału zaprezentowano sposób analizy % w pracy
