...
\begin{itemize}
\item Wybór biblioteki do wykrywania twarzy
\item 
\item Stworzenie algorytmu przetwarzającego obrazy ze zbioru treningowego,
\item Utworzenie algorytmu służącego do wykrywania wieku,
\item Opracowanie prostej aplikacji, która implementuje powyższe algorytmy,
\item Przeprowadzenie eksperymentów, które sprawdzają błąd w wykrywaniu wieku.
\end{itemize}
