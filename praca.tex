...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Na obrazie wykrywane są domniemane obszaru oczu.
    Oczy na zdjęciach zawsze są wyraźnie ciemniejsze od ich okolic.
    Algorytm skanuje każdy obszar zdjęcia poszukując
