...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    W tej Sekcji zostaną przedstawione typowe problemy napotkane podczas detekcji metodą Canny.
    W wielu zdjęciach dokonywane były nieprawidłowe detekcje zmarszczek.

    Pierwszym przykładem było coś tam...
    %Ustalone parametry
