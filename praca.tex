...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    from facial images'' analizują proporcje twarzy oraz ilość zmarszczek przy szacowaniu wieku.~\cite{dehshibiBastard} przy szacowaniu wieku
    ...
    Międzynarodową Komisję ds. Oświetlenia (International Commission on Illumination).
    ...
    Kolory mogą być także odwzorowane przez przestrzeń barw CMYK.
    ...
    która polega na mieszaniu kolorów przez odejmowanie promieniowań widzialnych różnych długości.
    ...
    W macierzy zostały użyte cztery pojęcia:
    \begin{itemize}
    ...
    W celu ich identyfikacji zastosowano detektor Canny.
    ...
    \begin{appendices}
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|}
                \hline
                $wiek$ & int & Szacowany wiek
                treningowych oraz
                konfigurację algorytmów treningowych \\ \hline
            \end{tabular}
        \end{table}
        ...
        \begin{itemize}
            ...
            instytut zajmujący się badaniami w za-
            kresie informatyki i automatyki
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item źródła programów .m i główna klasa generująca wrinkle feature w formacie .java
