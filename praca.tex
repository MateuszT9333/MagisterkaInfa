...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Wykrycie twarzy na obrazie jest możliwe dzięki algorytmom rozpoznawaniu obrazu.
    ...
    których dokładny opis znajduje sie w sekcji %todo.
    %todo odwolanie do Haara
    ...
    Filtry mają postać białych i czarnych prostokątów pogrupowanych w okna. %todo
