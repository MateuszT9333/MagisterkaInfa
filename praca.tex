...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Porównano średni współczynnik zmarszczek ze strefy 2 dla osób w wieku 17 lat z ilością krawędzi wykrytych z tej samej
    ...
    Na podstawie logów aplikacji sprawdzono czasy prztwarzania poszczególnych części algorytmów.
    ...
    Dla parametrów rozmycie = 2.0, liczba iteracji = 100 \epsilon = 1e-5 oraz liczba grup = 10 błąd MAE wyniósł 12,75 lat.
