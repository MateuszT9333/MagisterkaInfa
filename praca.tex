...
%    Poza nazwą dla kNNa we wstępie stosuje Pan drugie podejście. Co Pan wybierze jest obojętne, byle zawsze tak samo.
    ...
    \begin{figure}[h!]
        ...
        \caption{a) Oryginalny obraz b) Obraz z wykrytymi krawędziami.} %todo sprawdzic wszystkie obrazki
    ...
    %todo straszna przerwa

    \section{Algorytm analizy danych ze zbioru trenującego}\label{sec:algorytmTrenowania}
%    %todo W tym rozdziale nie ma nic o tym
%    co to jest algorytm analizy danych.
%    Wspomina Pan o Fuzzy c-means, ale to za mało.
%    Co chciał Pan zawrzeć w tym rozdziale?
    ...
    można
    oszacować wiek~\cite{wrinkleFeatures}. %todo sprawdzic referencje...
    ...
    Normalizacja jest realizowana przy zastosowaniu Wzoru~\ref{wzor.l2norm2} %todo wzór małymi literami
    \large
    \begin{equation}
    ...
    \end{equation}
    \normalsize
    gdzie $R_{i}$ oznacza wartość rzeczywistą wieku dla i-tego zdjęcia, $n$ oznacza liczbę zdjęć testowych. %todo sprawdzic w itemizach czy sa przecinki
    ...
    Warto zauważyć, że dla komórki o rozmiarach 3x3 nastąpiła znaczna poprawa MAE przy zwiększeniu liczby grup z 20 do
    50.

    Reasumując wyniki badań dla testowania 10\% zdjęć można powiedzieć, że najlepszy rezultat osiągnięto dla
    rozmiarów komórki 9x9. Zmiana parametrów FCM w niewielkim stopniu wpływały na jakość szacowania wieku, która
    oscylowała
    ...
    %todo wyeliminowac randomowe znaczki na stronie tytulowej
    %todo         Proszę usunąć sieroty - czyli pojedyncze litery na końcu linii. Twardą spację w tex robi się zamieniając spacje znakiem tyldy: o~którym.
    %todo Te nowe tabelki weszły w środek tekstu, a wszystkie tabele i figury powinny być umiejscowione na górze lub na dole strony. Proszę to poprawić.
