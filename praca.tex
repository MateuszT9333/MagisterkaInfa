...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Zdarza się, że twarz zostaje częściowo przysłonięta przez jakiś inny obiekt. Na przykład
    na zdjęciu, które obejmuje grupę wielu osób, część danej twarzy może być przysłonięta przez inną twarz.
    ...
    niej cienie i światła określane jako ostre \ref{fig.oswietlenieTwarzy}.
    \begin{figure}
        \centering
    ...
    \begin{figure}
        \centering
        \includegraphics[width=8cm]{Obrazy/wykrywanieStrefZmarszczkowych.jpg}
        \caption{Strefy zmarszczkowe widoczne w białych prostokątach.}
        \label{fig.wykrywanieStrefZmarszczkowych}
    \end{figure}

    Strefy zmarszczkowe są na czole, w górnej części nosa, górnej części policzków oraz w okolicach powiek.
    ...
    Autorzy \cite{wrinkleFeatures} algorytmu założyli, że odległość od linii oczy do linii brwi wynosi $0,4 \times d$.
    ...
    \begin{figure}
        \centering
        \includegraphics[width=11cm]{Obrazy/wspolrzedneDoWyliczeniaStref.jpg}
        \caption{Pomocnicze współrzędne do wyliczania stref zmarszczkowych.}
        \label{fig.wspolrzedneDoWyliczeniaStref}
    \end{figure}

    %todo opisac poszczegolne strefy
    %np strefa kolo powieki to polowa odleglosci pomiedzy x1,y1 a x1,y2 czyli de facto x1, y1-y2/2
    %i dodatkowo polowa cos tam
