...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Powyższe strefy zostały wymienione w sekcji \ref{sec:wyznaczanieStref}. Technika wykrywania zmarszczek
    znajdujących się w strefach jest opisana w sekcji \ref{sec:wykrywanieZmarszczek}. Wykryte zmarszczki
    pozwalają na obliczenie wrinkle feature dla danej twarzy - opis w sekcji \ref{sec:wyliczanieWrinkleFeature}.
    ...
    należy pogrupować - opis w sekcji \ref{sec:grupowanieDanych}. Ostatnią fazą algorytmu jest wykrywanie wieku
    na podstawie wyniki działania FCM - sekcja \ref{sec:wyznaczanieWieku}.
