...
\begin{document}
    ...
    * podkreślić właściwe
    ...
    Dla każdej metody dokonano porównania 10\% zdjęć ,
    ...
    \begin{figure}
        ...
        \label{fig.zlyRyjek}
    \end{figure}
    Z bazy zdjęć wyselekcjonowano 30 obrazów, na których zmarszczki zostały wykryte poprawnie, oraz 30 kolejnych obrazów, gdzie
    ...
    odchylenie standardowe współczynnika zmarszczek.
